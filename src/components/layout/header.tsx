        ...
        <ol className="flex h-full">
          {[
            ...
            <li
              key={nav.name}
              className={clsx(
                "relative font-bold flex items-center mx-4 text-red-400 after:transition-all after:ease-out after:duration-300 hover:bg-red-2001 hover:text-white1 cursor-pointer after:absolute after:w-full after:content-[''] hover:after:h-2 after:h-0 after:bottom-0 after:bg-red-200",
